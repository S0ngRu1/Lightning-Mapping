...
chj_ch3 =read_signal('..\\2024 822 85933.651462CH3.dat',signal_length,r_loction+ 34151156+165/5);
...
for i =1 :numel(yld_start_loc)
    ...
    %     [start_read_loc_chj, r_gccs] = get_match_single_yld_chj_find_peak(filtered_chj_signal1,filtered_yld_signal1,yld_start_loc(i),r_loction);
    ...
    chj_match_signal1 = filtered_chj_signal1(start_read_loc_chj-match_signal_length:start_read_loc_chj+match_signal_length+chj_signal_length);
    chj_match_signal2 = filtered_chj_signal2(start_read_loc_chj-match_signal_length:start_read_loc_chj+match_signal_length+chj_signal_length);
    chj_match_signal3 = filtered_chj_signal3(start_read_loc_chj-match_signal_length:start_read_loc_chj+match_signal_length+chj_signal_length);


    %     % 寻找峰值
    %     [peaks, locs] = findpeaks(chj_match_signal1, 'MinPeakHeight', 15, 'MinPeakDistance', 64);
    %     all_locs = locs;
    %     % 遍历所有峰值
    ...
    processed_chj_signal1 = real(windowsignal(detrend(chj_match_signal1)));
    processed_chj_signal2 = real(windowsignal(detrend(chj_match_signal2)));
