function [start_read_loc_chj, r_gccs, result_2e7] = get_match_single_yld_chj_siddle(yld_signal_start_loc, skip_large_window)
    ...
    for i = 1:length(window_lengths)
        ...
        current_chj_start_loc = current_chj_start_loc - current_window_length * 2;
        ...
        offset = subsignal_starts(max_idx) + floor(all_t_gccs(max_idx));
        current_chj_start_loc = current_chj_start_loc + offset;
