...
%% ==================== 1. 参数设置与数据加载 ====================
% --- 用户需根据实际情况修改的参数 ---
DATA_FILE = 'results/20250823172542_1505_result_yld_5.95e8_8.95e8_hann_2048_256_bandpass_hann_30e6_80e6.txt'; % 您的数据文件名
...
event1_range = [7.96e8, 8.96e8]; % 例如，正先导
...
% 上方子图的位置
top_width = (bottom_width - gap_horiz);
