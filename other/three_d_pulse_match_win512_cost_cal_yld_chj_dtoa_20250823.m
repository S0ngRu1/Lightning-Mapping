...
step = 1e6;
signal_length=step;
start_signal_loc = 594778000;
mapping_start_signal_loc = 594778000;
end_signal_loc = mapping_start_signal_loc+3e8;
% 所有信号的开始位置
...
noise_chj = read_signal_chj('20250823\software_CardOne_20250823172542.dat', noise_analysis_length, noise_analysis_length, 2);
filtered_noise_chj = filter_bp(noise_chj, 20e6, 80e6, 5);
threshold_chj = mean(filtered_noise_chj) + threshold_std_multiplier * std(filtered_noise_chj);
noise_yld = read_signal_tdms('20250823\20250823172542_5453CH3.tdms', noise_analysis_length, noise_analysis_length);
filtered_noise_yld = filter_bp(noise_yld, 20e6, 80e6, 5);
...
for j = 1:numel(all_start_signal_loc)-1
    ...
    yld_ch1 = read_signal_tdms('20250823\20250823172542_5453CH3.tdms',signal_length,start_read_loc_yld);
    yld_ch2 = read_signal_tdms('20250823\20250823172542_5453CH4.tdms',signal_length,start_read_loc_yld);
    yld_ch3 = read_signal_tdms('20250823\20250823172542_5453CH6.tdms',signal_length,start_read_loc_yld);
    ...
    for i =1 :num_yld_pulses
        ...
        chj_ch1 = read_signal_chj('20250823\software_CardOne_20250823172542.dat', match_signal_length*2, 9.6e8+ (current_chj_pulse_loc - match_signal_length)*4, 2);
        chj_ch2 = read_signal_chj('20250823\software_CardOne_20250823172542.dat', match_signal_length*2, 9.6e8+ (current_chj_pulse_loc - match_signal_length)*4+2, 2);
        chj_ch3 = read_signal_chj('20250823\software_CardTwo_20250823172542.dat', match_signal_length*2, 9.6e8+ (current_chj_pulse_loc - match_signal_length+ 215/2.5)*4, 2);
        ...
        if ~isempty(sub_S)
            ...
            dlta_t = t_yld-t_chj;
            dlta_T = (current_yld_pulse.loc-matched_chj_pulse.loc/5*5.00390073)*2.5;
            ...
            if dlta <= W
                ...
                if final_dlta_check_ns <= W && optimization_successful
                    ...
                    match_info_dtoa = struct(...
                        ...
                        'chj_loc', 9.6e8/4 + matched_chj_pulse.loc+ - snippet_len/2 +1, ...
                        'chj_azimuth', chj_az, ...
...
writetable(all_match_table, ...
           '20250823_3d_win512_cost_cal_yld_chj_dtoa.csv', ...  % 文件名
