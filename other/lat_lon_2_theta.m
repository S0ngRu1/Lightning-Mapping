% 输入两地的经纬度（单位：度）
%yld
lon1 = 113.5952098; % 第三个点的经度
lat1 = 23.6393631;  % 第三个点的纬度
lon2 = 113.5954496; % 第一个点的经度
lat2 = 23.6394115;  % 第一个点的纬度
% lon1 = 113.5958141; % 第二个点的经度
% lat1 = 23.6391452;  % 第二个点的纬度

%chj
% lat2 = 23.56888; % 第一个点的纬度
% lon2 = 113.614722; % 第一个点的经度
% 将经纬度转换为弧度
