...
% x = downsample(ch1,50);
% filtered_signalx = filter_bp(x, 20e6 ,80e6 , 8);
...
%         对信号进行滤波处理
        filtered_signal1 = real(FirFilter(win_signal1));
        filtered_signal2 = real(FirFilter(win_signal2));
        filtered_signal3 = real(FirFilter(win_signal3));
