...
% logicalIndex = abs(result1.corr12) > 0.4 & abs(result1.corr13) > 0.4 & abs(result1.corr23) > 0.4 & abs(result1.t123) < 1;
filteredTable1 = result1(logicalIndex, :);
logicalIndex = abs(result1.Rcorr) > 0.3 & abs(result1.t123) < 1;
%画图
scatter(filteredTable1.Azimuth,filteredTable1.Elevation,2);
% scatter(result1.Azimuth,result1.Elevation,2);
xlim([0, 360]);
xticks(0:40:360);
% 指定y轴范围和刻度标记
ylim([-40, 100]);
