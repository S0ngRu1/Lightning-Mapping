...
%自己的结果
figure;
logicalIndex = abs(result2.t123) < 1 & abs(result2.Rcorr) > 0.6 &  result2.Start_loc < 403e6 & result2.Start_loc > 401e6;
...
logicalIndex = abs(Untitled.VarName11) < 1 & abs(Untitled.VarName12) > 0.3 & Untitled.Paramers > 500000000 & Untitled.Paramers < 600000000 ;
