...
fprintf(fileID, 'Window-1024_Iteration-256_20-80_kalman-Q-0.5\n');
...
for  pi = 1:numel(peaks)
    ...
    for  wi = 1:numel(windows)
        ...
        fprintf(fileID, '%-13d%-15d%-15.6f%-15.6f%-15.6f%-15.6f%-15.6f%-15.6f%-15.6f%-15.6f%-15.6f\n', ...
            300000000+idx+windows(wi),513, t12, t13, t23, cos_alpha_opt, cos_beta_opt, Az_deg, El_deg, Rcorr,t123);
    end
    t = pi;
end
% 关闭文件
