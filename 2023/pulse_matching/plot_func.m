...
logicalIndex = abs(result1.t123) >1 & abs(result1.Rcorr) < 0.2 &  result1.Start_loc < 600000000 & result1.Start_loc > 400000000;
...
logicalIndex = abs(result2.t123) < 1 & abs(result2.Rcorr) > 0.5 & result2.Start_loc < 600000000 & result2.Start_loc > 400000000;
