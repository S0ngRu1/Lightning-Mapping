...
logicalIndex = abs(result2.t123) < 1 & abs(result2.Rcorr) > 0.3 & result2.Start_loc > 440100000  & result2.Start_loc < 440300000 ;
...
logicalIndex = abs(Untitled.VarName11) < 1 & abs(Untitled.VarName12) > 0.3 & Untitled.Paramers > 440100000 & Untitled.Paramers < 440300000 ;
