...
ch1 = read_signal('20240613171023.1120CH1.dat',signal_length,r_loction);
ch2 = read_signal('20240613171023.1120CH2.dat',signal_length,r_loction);
ch3 = read_signal('20240613171023.1120CH3.dat',signal_length,r_loction);
