...
for j = 1:numel(all_start_signal_loc)-1
    ...
    for i =1 :num_yld_pulses
        ...
        current_yld_pulse.loc = start_read_loc_chj- start_signal_loc + current_yld_pulse.loc;
        current_chj_pulse_loc = floor(current_yld_pulse.loc *5/5.00390073);
        chj_ch1 =read_signal('..\\2024 822 85933.651462CH1.dat',match_signal_length*2,start_signal_loc + current_chj_pulse_loc+ 34226222 - match_signal_length);
        chj_ch2 =read_signal('..\\2024 822 85933.651462CH2.dat',match_signal_length*2,start_signal_loc +current_chj_pulse_loc+ 34226222 - match_signal_length);
        chj_ch3 =read_signal('..\\2024 822 85933.651462CH3.dat',match_signal_length*2,start_signal_loc +current_chj_pulse_loc+ 34226222 - match_signal_length + 215/5);
        ...
        if ~isempty(matched_chj_pulse) && match_cost < cost_threshold
            matched_chj_pulse.loc = matched_chj_pulse.loc + current_chj_pulse_loc - match_signal_length - floor(snippet_len/2);
        ...
        if ~isempty(sub_S)
            ...
            dlta_t = t_yld-t_chj;
            dlta_T = (current_yld_pulse.loc-matched_chj_pulse.loc)*5;
