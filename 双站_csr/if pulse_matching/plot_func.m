%结果1
logicalIndex = abs(result1.t123) <1 & abs(result1.Rcorr) > 0.3 &  result1.Start_loc < 404238787+2e7 & result1.Start_loc > 404238787;
% logicalIndex = abs(result1.t123) <1 & abs(result1.Rcorr) > 0.3 &  result1.Start_loc < 469727621 + 34151156-85000+(469727621-3.6e8)/1282 & result1.Start_loc > mapping_start_signal_loc+ 34151156-85000 +(mapping_start_signal_loc-3.6e8)/1282;
