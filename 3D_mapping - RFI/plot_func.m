...
subplot(2,1,1);plot(chj_signal3);title('chj_signal3');xlabel('采样点数');ylabel('幅值');
subplot(2,1,2);plot(filtered_chj_signal3);title('filtered_chj_signal3');xlabel('采样点数');ylabel('幅值');
