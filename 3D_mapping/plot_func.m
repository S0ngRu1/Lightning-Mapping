...
% %结果2
% figure;
 logicalIndex = abs(result2.t123) <1 & abs(result2.Rcorr) > 0.3 &  result2.Start_loc < 5.2e8 & result2.Start_loc > 4.7e8;
...
%结果3
logicalIndex = abs(result3.t123) < 1 & abs(result3.Rcorr) > 0.3 &  result3.Start_loc < 4.9e8 & result3.Start_loc > 4.4e8;
