...
scout_window_len = 1e4; % 侦察窗口大小
scout_step = scout_window_len;       % 侦察窗口的滑动步长
...
for i = 1:num_windows
    ...
    win_end = win_start + scout_window_len - 1;
    segment = waveform(win_start:win_end);
    pulse_catalog_segment = find_pulses_advanced(segment, noise_std, sampling_rate_hz, detection_threshold_factor, 5);
