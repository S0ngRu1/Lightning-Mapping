...
file_name = 'results\20240822165932_loop_result_yld_3.65e8_5e8_window_1024_256_去零飘_'+string(fp_start/1e6)+'_'+string(fp_end/1e6)+'_'+ window +'.txt';
% 打开一个文本文件用于写入运行结果
