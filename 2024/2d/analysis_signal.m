%% 正先导信号
% 1. 第一段信号（3.8 - 3.84e8 区间）
% 读取信号
signal1 = read_signal('..\\20240822165932.6610CH1.dat', 0.04e8, 3.8e8);
...
% 打印结果（可选，验证数据）
fprintf('第一段信号（3.8 - 3.84e8）：\n');
fprintf('原始均值 = %.4f\n', mean_all1);
fprintf('大于原始均值的元素的均值 = %.4f\n', mean_above_mean1);
fprintf('峰值 = %.4f\n\n', peak_value1);


% 2. 第二段信号（3.84 - 3.88e8 区间，高度6000-7500）
% 读取信号
signal2 = read_signal('..\\20240822165932.6610CH1.dat', 0.04e8, 3.84e8);
...
% 打印结果（可选，验证数据）
fprintf('第二段信号（3.84 - 3.88e8，高度6000-7500）：\n');
fprintf('原始均值 = %.4f\n', mean_all2);
fprintf('大于原始均值的元素的均值 = %.4f\n', mean_above_mean2);
fprintf('峰值 = %.4f\n', peak_value2);
