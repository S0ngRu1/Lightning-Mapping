...
% === 几何与文件参数 ===
signal_length = 1.35e8; % 总处理长度
r_loction = 3.655e8;     % 起始绝对位置
d12 = 24.9586;
d13 = 34.9335;
d23 = 24.9675;
angle12 = -110.8477;
...
while current_read_offset < signal_length
    ...
    ch1 = read_signal('..\\20240822165932.6610CH1.dat',current_len, current_abs_loc);
    ch2 = read_signal('..\\20240822165932.6610CH2.dat',current_len, current_abs_loc);
    ch3 = read_signal('..\\20240822165932.6610CH3.dat',current_len, current_abs_loc);
    % 3. 滤波
