...
start_read_loc_yld =470500587;
end_read_loc_yld = 478984020;
% 引入两个站的位置关系
yld_sit = [0, 0, 0];
...
% 筛选 match_results，获取满足条件的行索引
% 筛选条件
condition1 = [match_results.dlta] < 30000;
condition2 = [match_results.yld_start_loc] > 4.6e8;
condition3 = [match_results.yld_start_loc] < 4.8e8;
...
filtered_S_temp = S_results(filtered_match_indices, :);
