...
original_signal_length = 3e8;
original_signal_loc = 3e8;
noisy_signal = read_signal('../20240822165932.6610CH1.dat', original_signal_length, original_signal_loc);
% noisy_signal= read_signal('../2024 822 85933.651462CH1.dat', original_signal_length, original_signal_loc + 34371950);
...
for i =1 :numel(yld_start_loc)
    ...
    threshold = 7*std(filtered_chj_noise);
    % 寻找峰值
