function [start_loc, azimuth, elevation, Rcorr, t123]  = get_2d_result_single_window_find_peak(start_loc,ch1,ch2,ch3 )
% 从化局
N = 3;
d12 = 41.6496;
d13 = 48.5209;
...
[r12_gcc,lags12_gcc] = xcorr(ch1,ch2,'normalized');
[r13_gcc,lags13_gcc] = xcorr(ch1,ch3,'normalized');
[r23_gcc,lags23_gcc] = xcorr(ch2,ch3,'normalized');
R12_gcc = max(r12_gcc);
R13_gcc = max(r13_gcc);
R23_gcc = max(r23_gcc);
